                  ...
                  unsigned short wordColor,unsigned short backColor,unsigned char refresh,unsigned char mode)
{
    ...
    x = (width/2)-(strlen(buf1)*4);
    LCDShowFont16(x,y+2,buf1,strlen(buf1)*8,wordColor,backColor);
    x = (width/2+width)-(strlen(buf2)*4);
    LCDShowFont16(x,y+2,buf2,strlen(buf2)*8,wordColor,backColor);
    x = (width/2+width*2)-(strlen(buf3)*4);
    LCDShowFont16(x,y+2,buf3,strlen(buf3)*8,wordColor,backColor);
}
