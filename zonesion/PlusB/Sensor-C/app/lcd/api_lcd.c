...
void xLabPageShow(uint8_t refresh)
{
    ...
    if(CurrMode==1)
    {
        ...
        if(A1)
            ...
            sprintf(pbuf2," 静止 ");
        lcdShowBarX4(y+=20,"人体红外",pbuf1,"震动",pbuf2,penColor,backColor,refresh,1);
    }
    else if(CurrMode==2)
    {
        if(A0)
    ...
    if(CurrMode==1)
    {
        ...
        if(A3)
            ...
            sprintf(pbuf2,"无明火");
        lcdShowBarX4(y+=20,"霍尔",pbuf1,"火焰",pbuf2,penColor,backColor,refresh,1);
    }
    else if(CurrMode==2)
    ...
    if(A5)
        ...
        sprintf(pbuf2,"无遮挡");
    lcdShowBarX4(y+=20,"燃气",pbuf1,"光栅",pbuf2,penColor,backColor,refresh,1);
