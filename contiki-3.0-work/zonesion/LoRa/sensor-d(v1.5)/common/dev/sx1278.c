...
**------------------------------------------------------------------------------------------------------
********************************************************************************************************/
static void  SX1276LoRaSetRFFrequency(unsigned bf) {
	SX1276WriteBuffer( REG_LR_FRFMSB, BaseFreq[bf-420][0]);//0x04???????????
	SX1276WriteBuffer( REG_LR_FRFMID, BaseFreq[bf-420][1]);//0x07???????????
	SX1276WriteBuffer( REG_LR_FRFLSB, BaseFreq[bf-420][2]);//0x00???????????
}
/*********************************************************************************************************
** Function			: 
** Description	:
