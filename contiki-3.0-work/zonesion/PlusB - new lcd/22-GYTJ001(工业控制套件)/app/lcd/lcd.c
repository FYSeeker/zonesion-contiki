...
void lcdPageDefault(unsigned char refresh)
{
    ...
    lcdShowSensorInfo(120-30,LCD_COLOR_DARK_RED,LCD_COLOR_BLACK,LCD_COLOR_GRAY_1,refresh);
    lcdShowHumiture(220,LCD_COLOR_BLACK,LCD_COLOR_GRAY_1,refresh);
}
...
void lcdPageZigbee(unsigned char refresh)
{
    ...
    u16 backColor_2 = LCD_COLOR_GRAY_1;
    char buf1[32]={0};
    char buf2[32]={0};
    ...
    if(refresh&0x80)
    {
        ...
        LCDShowFont16(319-(8*3),2,"K1>",24,LCD_COLOR_GRAY_4,LCD_COLOR_RED);
...
void lcdPageBle(unsigned char refresh)
{
    ...
    if(refresh&0x80)
    {
        ...
        LCDShowFont16(319-(8*3),2,"K1>",24,LCD_COLOR_GRAY_4,LCD_COLOR_BLUE);
...
void lcdPageWifi(unsigned char refresh)
{
    ...
    if(refresh&0x80)
    {
        ...
        LCDShowFont16(319-(8*3),2,"K1>",24,LCD_COLOR_GRAY_4,LCD_COLOR_DARK_GREEN);
    }
    y=20;
    lcdShowBarX1(y,"网络信息",LCD_COLOR_WHITE,TitleColor,refresh,0);
    y+=20;
...
void lcdPageLora(unsigned char refresh)
{
    ...
    if(refresh&0x80)
    {
        ...
        LCDShowFont16(319-(8*3),2,"K1>",24,LCD_COLOR_GRAY_4,LCD_COLOR_PURPLE);
    }
    y=20;
    lcdShowBarX1(y,"网络信息",LCD_COLOR_WHITE,TitleColor,refresh,0);
    y+=20;
...
void lcdPage_NB(uint8_t refresh)
{
    ...
    static u16 backColor_2 = LCD_COLOR_GRAY_1;
    ...
    if(refresh&0x80)
    {
        ...
        LCDShowFont16(319-(8*3),2,"K1>",24,LCD_COLOR_GRAY_4,wordColor);
    }
    y=20;
    lcdShowBarX1(y,"网络信息",LCD_COLOR_WHITE,TitleColor,refresh,0);
    y+=20;
